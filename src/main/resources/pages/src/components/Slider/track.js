...
var getSlideClasses = function(spec){
    ...
    return classnames({
        'ucs-slick-slide': true,
        'ucs-slick-active': slickActive,
        'ucs-slick-center': slickCenter,
        'ucs-slick-cloned': slickCloned
    });
};
...
var Track = React.createClass({
    ...
    render: function () {
        ...
        return (
            <div className='ucs-slick-track' style={this.props.trackStyle}>
                { slides }
            </div>
        );
    }
