...
var InnerSlider = React.createClass({
    ...
    render: function () {
        var className = classnames('ucs-slick-initialized', 'ucs-slick-slider', this.props.className, {
