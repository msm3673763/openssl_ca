...
var trackHelper = require('./trackHelper');
var helpers = {
    initialize: function (props) {
        ...
        this.setState({
            ...
            var targetLeft = trackHelper.getTrackLeft(assign({
                slideIndex: this.state.currentSlide,
                trackRef: this.track
            }, props, this.state));

            // getCSS function needs previously set state
            var trackStyle = trackHelper.getTrackCSS(assign({left: targetLeft}, props, this.state));
    ...
    slideHandler: function (index) {
        ...
        targetLeft = trackHelper.getTrackLeft(assign({
            slideIndex: targetSlide,
            trackRef: this.track
        }, this.props, this.state));

        currentLeft = trackHelper.getTrackLeft(assign({
        ...
        if (this.props.useCSS === false) {
            ...
            this.setState({
                currentSlide: currentSlide,
                trackStyle: trackHelper.getTrackCSS(assign({left: currentLeft}, this.props, this.state))
            }, function () {
            ...
            this.setState({
                animating: true,
                currentSlide: currentSlide,
                trackStyle: trackHelper.getTrackAnimateCSS(assign({left: targetLeft}, this.props, this.state))
            }, function () {
                this.animationEndCallback = setTimeout(callback, this.props.speed);
            });
