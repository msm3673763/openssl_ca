...
var EventHandlers = {
    ...
    swipeMove: function (e) {
        ...
        curLeft = trackHelper.getTrackLeft(assign({
        ...
        this.setState({
            ...
            swipeLeft: swipeLeft,
            trackStyle: trackHelper.getTrackCSS(assign({left: swipeLeft}, this.props, this.state))
        });
    ...
    getSlideCount: function() {
        ...
        if (this.props.swipeToSlide) {
            ...
            var slides = slickList.querySelectorAll('.ucs-slick-slide');
    ...
    swipeEnd: function (e) {
        ...
        if (touchObject.swipeLength > minSwipe) {
            ...
            var currentLeft = trackHelper.getTrackLeft(assign({
                slideIndex: this.state.currentSlide,
                trackRef: this.track
            }, this.props, this.state));

            this.setState({
                trackStyle: trackHelper.getTrackAnimateCSS(assign({left: currentLeft}, this.props, this.state))
            });
        }
    },
